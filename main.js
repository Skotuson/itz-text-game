...
function getAvailableActions() {
    ...
    if (gameState.floor === 9.80) {
        qsTxt.innerHTML = ("'O meterologii. Celý kraj sužuje už několik let brutální bouřka. Snažím se jí ovladnout a využít jí ve svůj prospěch.'");
        actions.push("'Jsem já hoden?'");
    }
    ...
    if (gameState.floor === 14) {
        qsTxt.innerHTML = ("Vydáváš se na úkol který ti zadal tvůj nový pán Meter Olog. Máš dojít do hlavního města, které nese název Tariwal. Před tebou je dlouhá cesta, příliš dlouhá na toto vyprávění.")
        actions.push("Dále");
    }
